    ...
    <div style={{ maxWidth: 720 }}>
      ...
      {path === '' && (
        <div>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, letterSpacing: '-0.04em', color: textPrimary, marginBottom: 16, lineHeight: 1.15 }}>
            {intro.title ?? 'Introduction to Orchestra'}
          </h1>
          <p style={{ fontSize: 17, color: textMuted, lineHeight: 1.75, marginBottom: 32 }}>
            {intro.description ?? 'Orchestra is an AI-native IDE platform that connects your AI agents to a unified plugin backbone. 290 tools, 36 plugins, 17 packs, 5 platforms, one protocol.'}
          </p>
          ...
          <p style={{ fontSize: 15, color: textMuted, lineHeight: 1.75, marginBottom: 24 }}>
            {intro.what_is ?? 'Orchestra solves the fragmentation problem in AI tooling. Instead of gluing together separate tools for project management, vector search, agent orchestration, and file storage, Orchestra provides all of these as MCP-compatible tools via a unified plugin mesh.'}
          </p>
      ...
      {path === 'installation' && (
        <div>
          ...
          <p style={{ fontSize: 17, color: textMuted, lineHeight: 1.75, marginBottom: 32 }}>
            {installation.description ?? 'Install Orchestra using the install script (recommended) or download a platform-specific binary.'}
          </p>
      ...
      {path === 'quick-start' && (
        <div>
          ...
          <p style={{ fontSize: 17, color: textMuted, lineHeight: 1.75, marginBottom: 32 }}>
            {quickStart.description ?? 'Get Orchestra running and connected to your AI client in under 5 minutes.'}
          </p>
          ...
          <div style={{ padding: '20px 24px', borderRadius: 12, background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.2)', marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 14, color: textMuted, margin: 0 }}>
              {quickStart.ready_msg ?? 'Orchestra is running. Your AI client now has access to 290 tools across project management, RAG memory, agent orchestration, and more.'}
            </p>
          </div>
        </div>
      )}
