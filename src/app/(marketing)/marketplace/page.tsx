...
const packs = [
  { name: 'go-backend', displayName: 'Go Backend', desc: 'Skills and agents for Fiber v3, GORM, JWT, asynq, and Go API development.', skills: 12, agents: 3, hooks: 2, color: '#00acd7' },
  { name: 'rust-engine', displayName: 'Rust Engine', desc: 'Tonic gRPC, Tree-sitter, Tantivy, rusqlite, and Rust plugin development.', skills: 10, agents: 2, hooks: 1, color: '#f74c00' },
  { name: 'typescript-react', displayName: 'TypeScript + React', desc: 'React, Zustand, React Query, Vite, shadcn/ui, and modern frontend patterns.', skills: 14, agents: 4, hooks: 3, color: '#3178c6' },
  { name: 'database-sync', displayName: 'Database & Sync', desc: 'PostgreSQL, pgvector, SQLite, Redis, and cross-database sync protocol.', skills: 8, agents: 2, hooks: 1, color: '#336791' },
  { name: 'ai-agentic', displayName: 'AI & Agentic', desc: 'Anthropic SDK, OpenAI, RAG, vector search, embeddings, and agent workflows.', skills: 16, agents: 6, hooks: 2, color: '#a900ff' },
  { name: 'chrome-extension', displayName: 'Chrome Extension', desc: 'Manifest V3, service worker, content scripts, and side panel development.', skills: 7, agents: 1, hooks: 2, color: '#4285f4' },
  { name: 'macos-integration', displayName: 'macOS Integration', desc: 'CGo, Spotlight, Keychain, iCloud, Notifications, and file associations.', skills: 9, agents: 2, hooks: 1, color: '#999' },
  { name: 'gcp-infrastructure', displayName: 'GCP Infrastructure', desc: 'Cloud Run, Cloud SQL, CDN, Docker, nginx, Sentry, and PostHog.', skills: 11, agents: 3, hooks: 4, color: '#4285f4' },
]
        ...
        {packs.map(pack => (
          <div key={pack.name} style={{ padding: '24px', borderRadius: 16, border: `1px solid ${cardBorder}`, background: cardBg, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 16, fontWeight: 700, color: textPrimary, marginBottom: 4 }}>{pack.displayName}</div>
