  ...
  return (
    <div style={{ maxWidth: 420, margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700, color: textPrimary, margin: 0, letterSpacing: '-0.02em' }}>Two-factor authentication</h1>
        <p style={{ fontSize: 14, color: textMuted, marginTop: 8 }}>
          {savedEmail
            ? <>Signing in as <strong style={{ color: textPrimary }}>{savedEmail}</strong></>
          ...
          {!useRecovery ? (
            ...
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: hintColor }}>Recovery code</label>
                <input
                ...
                />
                <div style={{ fontSize: 12, color: hintColor }}>Recovery codes were provided when you enabled 2FA.</div>
              </div>
              <button
