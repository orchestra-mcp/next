  ...
  return (
    <div style={{ maxWidth: 420, margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700, color: textPrimary, margin: 0, letterSpacing: '-0.02em' }}>Set new password</h1>
        <p style={{ fontSize: 14, color: textMuted, marginTop: 8 }}>Choose a strong password for your account.</p>
      </div>
      ...
      <div style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 20, padding: '32px 28px', backdropFilter: 'blur(16px)', boxShadow: cardShadow }}>
        {done ? (
          <div style={{ textAlign: 'center', padding: '8px 0' }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 600, color: textPrimary, marginBottom: 10 }}>Password updated!</div>
            <div style={{ fontSize: 13, color: textMuted, marginBottom: 24 }}>You can now sign in with your new password.</div>
            <button
          ...
          <>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: labelColor }}>New password</label>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: labelColor }}>Confirm password</label>
                <div style={{ position: 'relative' }}>
                  <input
